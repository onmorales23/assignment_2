...
qqplot(cate_m, data$GenML_CATEa)
qqplot(CATE_causalForest, data$GenML_CATEa)

# boxplot 

boxplot(cate_m, CATE_causalForest, data$GenML_CATEa,
...
Comparing CATEs estimated between methods we found
